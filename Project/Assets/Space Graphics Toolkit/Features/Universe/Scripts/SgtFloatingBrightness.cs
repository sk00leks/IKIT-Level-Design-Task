...
namespace SpaceGraphicsToolkit
{
	...
	[ExecuteInEditMode]
	[HelpURL(SgtHelper.HelpUrlPrefix + "SgtFloatingBrightness")]
	[AddComponentMenu(SgtHelper.ComponentMenuPrefix + "Floating Brightness")]
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtFloatingBrightness_Editor : SgtEditor
	{
