...
namespace SpaceGraphicsToolkit
{
	...
	public static class SgtOcclusion
	{
		...
		public static void TryScaleBackDistantPositions(Transform cachedTransform, ref Vector4 worldEye, ref Vector4 worldTgt, float worldRadius)
		{
			...
			var closeDst = NearestDist(worldEye, worldDir, cachedTransform.position) + worldRadius;
